...
urlpatterns = [
    ...
    path("state/<str:id>/", core.state, name="state"),
    path("states/", core.states, name="states"),
    path(
        "",
        login_required(
...
admin.site.site_header = "Debbie administration"
admin.site.site_tite = "Debbie site admin"
